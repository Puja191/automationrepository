...
public class ActiTimeCreateProjects_Customers extends BaseTest{
	...
	public void createValidCustomer_ProjectTestScript() throws IOException, EncryptedDocumentException, InterruptedException
	{
		   ...
		   LoginPage lp=new LoginPage(driver);
	         ...
	         tp.create_New_Customer_Method(flib.readExcelData(EXCEL_PATH, CUST_PRO_SHHET_NAME, 1, 0));
	  tp.create_New_Project_Method(flib.readExcelData(EXCEL_PATH, CUST_PRO_SHHET_NAME, 1, 0),flib.readExcelData(EXCEL_PATH, CUST_PRO_SHHET_NAME, 1, 1));
